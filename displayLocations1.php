...
Results of courses_offered Database<br><br>
...
// Select the personal database 
  if (! @mysql_select_db("quickme1_4211") ) { 
   ...
   $query = "SELECT * FROM `courses_offered` ORDER BY `course_description";
   ...
   if( $results )
   {
      while( $courses_offered = mysql_fetch_object( $results ) )
      {
         ...
         echo( "$courseID<br>, $course_description<br>, $Credit_hours<br>, $Semester<br><br><br>" );
      }
   }
   else
   {
